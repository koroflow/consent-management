	...
	return {
		...
		async createPurpose(
			purpose: Omit<ConsentPurpose, 'createdAt' | 'updatedAt'> &
				Partial<Pick<ConsentPurpose, 'createdAt' | 'updatedAt'>>
		...
		async updatePurpose(
			id: string,
			data: Partial<ConsentPurpose> & { updatedAt?: Date }
		): Promise<ConsentPurpose> {
		...
		async createConsent(
			consent: Omit<ConsentRecord, 'createdAt' | 'updatedAt'> &
				Partial<Pick<ConsentRecord, 'createdAt' | 'updatedAt'>>
		...
		async updateConsent(
			id: string,
			data: Partial<ConsentRecord> & { updatedAt?: Date }
		): Promise<ConsentRecord> {
		...
		async logConsentChange(
			event: Omit<ConsentChangeEvent, 'timestamp'> & { timestamp?: Date }
