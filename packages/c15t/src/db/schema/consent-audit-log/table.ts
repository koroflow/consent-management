	...
	return {
		...
		fields: {
			...
			entityType: {
				type: 'string',
				required: true,
				fieldName: options.consentAuditLog?.fields?.entityType || 'entityType',
			},
			...
			entityId: {
				type: 'string',
				required: true,
				fieldName: options.consentAuditLog?.fields?.entityId || 'entityId',
			},
			...
			actionType: {
				type: 'string',
				required: true,
				fieldName: options.consentAuditLog?.fields?.actionType || 'actionType',
			},
			...
			userAgent: {
				type: 'string',
				required: false,
				fieldName: options.consentAuditLog?.fields?.userAgent || 'userAgent',
			},
			...
			metadata: {
				type: 'string[]',
				required: false,
				fieldName: options.consentAuditLog?.fields?.metadata || 'metadata',
			},
