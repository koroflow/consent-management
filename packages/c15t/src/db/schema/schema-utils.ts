...
/**
 * Parse output data from database to client format
 */
...
/**
 * Get all fields for a table including plugin fields
 */
...
/**
 * Parse input data from client to database format
 */
...
/**
 * Merge schema with configuration
 */
