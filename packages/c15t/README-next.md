...
2. Create a shared c15t instance:
   ...
   import { memoryAdapter } from '@c15t/temp/storage/memory';
...
import { getServerConsent } from '@c15t/temp/integrations/server';
...
// app/actions.ts
'use server'
import { setServerConsent } from '@c15t/temp/integrations/server';
...
import { checkConsentCookie } from '@c15t/temp/integrations/next';
...
// lib/c15t.ts
import { c15t } from '@c15t/temp';
import { cookieAdapter } from '@c15t/temp/storage/cookie';
